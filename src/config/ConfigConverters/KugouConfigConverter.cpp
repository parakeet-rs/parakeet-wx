...
void adl_serializer<KugouConfig>::from_json(const json& j, KugouConfig& data) {
  ...
  data.v4_file_key_expansion_table = j.value("v4_file_key_expansion_table",
  def.v4_file_key_expansion_table); data.v4_slot_key_expansion_table =
  j.value("v4_slot_key_expansion_table", def.v4_slot_key_expansion_table);
}
